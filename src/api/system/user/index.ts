...
// 查询用户列表，用于流程里的用户选择
export function selectUser(query: any) {
  return request({
...
export const userOptions = (): AxiosPromise<UserVO[]> => {
  return request({
 ...
 * @param query
 */
export const filterListUser = (query: UserQuery): AxiosPromise<UserVO[]> => {
  return request({
    url: '/system/user/list/filter',
    method: 'get',
    params: query
  });
};
