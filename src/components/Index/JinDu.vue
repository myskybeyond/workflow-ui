<template>
    ...
    <div class="mb-[10px]" v-show="showSearch">
      <el-card shadow="hover">
        <el-form :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
          ...
          <el-form-item prop="orderId" style="margin-bottom: 0">
            <el-select v-model="queryParams.orderId" placeholder="请选择订单" clearable filterable @change="selectOne">
  ...
  <el-table v-loading="loading" :data="dataList">
    ...
    <el-table-column label="销售订单名称" align="center" prop="orderName" :show-overflow-tooltip="true"/>
...
import {getOrderFlwReationList} from "@/api/Index";
...
async function getList() {
  loading.value = true;
  await getOrderFlwReationList(queryParams.value).then((res) => {
