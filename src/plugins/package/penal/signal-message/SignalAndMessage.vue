<template>
  <div class="panel-tab__content">
    <div class="panel-tab__content--title">
      <span
        ><i style="margin-right: 8px; color: #555555"> <Menu class="panel-tab-icon__title" /> </i>消息列表</span
      >
    ...
    <div class="panel-tab__content--title" style="padding-top: 8px; margin-top: 8px; border-top: 1px solid #eeeeee">
      <span><i style="margin-right: 8px; color: #555555">
        <Menu class="panel-tab-icon__title" />
      </i>信号列表</span>
