...
import { myListProjectFileInfo, getProjectFileInfo, delProjectFileInfo, addProjectFileInfo, updateProjectFileInfo ,listProjectFileVersionInfo} from '@/api/business/projectFileInfo';
...
import { listCategoryInfoMyFileNum } from "@/api/business/categoryInfo";
...
const getList = async () => {
  ...
  const res = await myListProjectFileInfo(queryParams.value);
...
const getTreeSelect = async () => {
  const res = await listCategoryInfoMyFileNum(queryParams.value);
