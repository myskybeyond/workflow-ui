<template>
  <div class="message_of_user_task panel-tab__content">
    ...
    <h4><b>消息模板</b></h4>
    <el-select v-model="copyNoticeIds" size="small" placeholder="请选择 模板" clearable filterable style="width: 240px;" @change="copyNoticeChange">
  ...
  <div class="message_of_user_task panel-tab__content">
    ...
    <h4><b>消息模板</b></h4>
    <el-select
      v-model="completeNoticeIds"
      size="small"
      placeholder="请选择 模板"
      clearable
      filterable
      style="width: 240px;"
      @change="completeNoticeChange"
    >
      <el-option v-for="item in msgTemplateOptions" :key="item.id" :label="item.name" :value="item.id"></el-option>
    </el-select>
  </div>
